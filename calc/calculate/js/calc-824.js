function MDCalc(z) {
    var score1 = 0;
    //1.1-1.13得分
    var key1 = ['item1', 'item2', 'item3', 'item4', 'item5', 'item6', 'item7', 'item8', 'item9', 'item10', 'item11', 'item12', 'item13'];
    var num1 = 0;
    ...
    if (num1 == key1.length && num2 == key2.length && num3 == key3.length && num4 == key4.length) {
